...
def generate():
    ...
    test_data = [
        ('1', 'طالب - 01 (عربي)', '1', 'صحية', 'CSC 1201', 'مؤهل'),
        ('2', 'طالب - 02 (عربي)', '0', 'عائلية', 'CEN 1301', 'مؤهل'),
        ('3', 'طالب - 03 (عربي)', '1', 'أكاديمية', 'MATH 1204', 'مؤهل'),
        ('4', 'طالب - 04 (عربي)', '1', 'نفسية', 'PHYS 1251', 'مؤهل'),
        ('5', 'طالب - 05 (عربي)', '3', 'مالية', 'CSC 1304', 'مؤهل'),
        ('6', 'طالب - 06 (إنجليزي)', '0', 'وظيفية', 'CEN 1303', 'مؤهل'),
        ('7', 'طالب - 07 (عربي)', '2', 'أخرى', 'MATH 1205', 'مؤهل'),
        ('8', 'طالب - 08 (عربي)', '1', 'صحية', 'CSC 1103', 'مؤهل'),
        ('9', 'طالب - 09 (عربي)', '0', 'عائلية', 'CEN 1201', 'مؤهل'),
        ('10', 'طالب - 10 (عربي)', '17', 'أكاديمية', 'CEN 1303', 'غير مؤهل'),
    ]
